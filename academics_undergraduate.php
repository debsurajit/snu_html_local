      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-7 middle-content">
          <div class="animatedParent">
              <h1 class="animated fadeIn slowest">Undergraduate</h1>
          ...
          <div class="button-section animatedParent clearfix">
                <a href="academics_undergraduate-major.php" class="undergraduate-brown-button pull-left animated bounceInUp slower clearfix"><dd><span>Major in</span> Electronics & Electronics Engineering</dd></a>
                <a href="academics_undergraduate-minor.php" class="undergraduate-gray-button pull-right animated bounceInUp slower"><dd><span>Minor in</span> Electronics & Electronics Engineering</dd></a>
            </div>
           <div class="animatedParent">      
                  <h3 class="animated fadeIn slower">Electrical & Electronics Engineering</h3>
          ...
          <div class="button-section animatedParent clearfix">
                    <a href="" class="undergraduate-brown-button pull-left animated bounceInUp slower"><dd><span>Major in</span> Electronics Engineering</dd></a>
                    <a href="" class="btn undergraduate-gray-button pull-right animated bounceInUp slower"><dd><span>Minor in</span> Electronics Engineering</dd></a>
            </div>
        ...
        <!-- Right Panel Start -->
        <div class="col-lg-4 col-md-4 col-sm-5 right-panel academic-calender animatedParent">
            <div class="animated bounceInUp slower">
             <?php include 'include/academic-calender-right-section.php';?>
            </div>
        </div>
        <!-- Right Panel End -->
      </div>
