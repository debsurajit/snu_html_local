...
<html lang="en">
<head>
  <title>Home | School of Engineering</title>
  <meta charset="utf-8">
...
<header class="main-header">
            ...
            <nav class="navbar navbar-default">
                ...
                <div class="navbar-collapse" >
                  <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle top-slide" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">School of Engineering <span class="caret"></span></a>
    ...
    </div><!--- logo and search section end -->
    
<div class="department-main-menu">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <nav class="navbar navbar-default">
