<?php include 'header.php';?>
  ...
  <div class="container margin-top offset-top">
    ...
    <div class="breadcrumb col-md-offset-3">Resource / <span>Learning & Academic Support Center</span></div>

    <!-- Left Panel Start -->
    <div class="col-sm-3">
        <div class="left-menu-wrapper">
            <?php include 'include/resource-side-menu.php';?>
        </div>
    </div>
    <!-- Left Panel End -->
    ...
    <div class="col-sm-9">
      ...
      <div class="middle-content">
        <div class="animatedParent">
          <h1 class="animated fadeIn slower">Learning & Academic Support Center</h1>
        </div>
        <div class="animatedParent">
