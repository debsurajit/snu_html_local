...
<?php include 'include/header.php';?>
  ...
  <section class="container-fluid fixed-pad content-wrapper">
      ...
      <div class="breadcrumb">
        ...
        <h1 class="animated bounceInUp slowest">Chancellor</h1>
     
        
      
         
        <div class="col-sm-5 animated bounceInLeft slowest">
        ...
        <div class="col-sm-7 animated bounceInRight slowest">
    ...
    <div class="container middle-panel animatedParent">
      
      
      <!-- Left Panel Sart -->
                     
      <div class="col-md-8 col-sm-6 col-xs-12 left-panel animated bounceInLeft slowest">
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 right-panel animated bounceInRight slowest">
 ...
 <!-- Bottom Body Start -->
  <section class="container-fluid prev-chancellor animatedParent">
    <div class="container">
      <h2>Previous Chancelor</h2>
      <div class="col-sm-4 animated bounceInLeft slowest">
      ...
      <div class="col-sm-8 prev-text animated bounceInRight slowest">
      <p>Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero.</p>
      <p>Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero.</p>
    </div>
    </div>
