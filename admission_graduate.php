      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-7 middle-content">
          ...
          <div class="button-section animatedParent clearfix">
                <a href="" class="undergraduate-brown-button pull-left animated bounceInLeft slower"><span>Masters in</span> Electronics & Electronics Engineering</a>
                <a href="" class="undergraduate-gray-button pull-right animated bounceInRight slower"><span>Masters in</span> Electronics Engineering</a>
              <a href="" class="undergraduate-brown-button pull-left animated bounceInLeft slower"><span>Doctoral in</span> Electronics Engineering</a>
