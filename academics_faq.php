<?php include 'header.php';?>
  ...
  <div class="container margin-top offset-top">
    ...
    <div class="breadcrumb col-sm-offset-3">Academics / <span>FAQ</span></div>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-7 middle-content">
          <div class="animatedParent">
              <h1 class="animated fadeIn slowest">Frequently Asked Questions</h1>
...
<div class="form-group">
  ...
  <input id="textinput" name="textinput" type="text" placeholder="| Email ID" class="form-control input-md">
    
  </div>
  <div class="col-lg-2 col-md-2 col-sm-12">
    <button id="singlebutton" name="singlebutton" class="btn btn-primary">Ask</button>
  </div>
</div>
        ...
        <!-- Right Panel Start -->
        <div class="col-lg-4 col-md-4 col-sm-5 right-panel faq-right-panel academic-calender animatedParent">
          ...
          <div class="animated bounceInUp slower">
            ...
            <p>
              ...
              Position Title<br/>
              1234567890 Ext: 321<br/>
              <a href="mailto:name.name@snu.edu.in">name.name@snu.edu.in</a>
            </p>
            </div>
          </div>
