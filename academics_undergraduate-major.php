...
<a href="#" class="button-apply">Apply Now</a>
  ...
  <div class="container margin-top offset-top">
    ...
    <div class="breadcrumb col-sm-offset-3">Academics / undergraduate / <span>Major</span></div>
    ...
    <div class="col-sm-3">
      ...
      <ul class="leftmenu-bottom">
            <li><a href="academics_undergraduate-minor.php">Check our Minor in EE</a></li>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-7 middle-content">
          <div class="animatedParent">
              <h1 class="animated fadeIn slowest">B.Tech in Electrical Engineering</h1>
        ...
        <div class="col-lg-4 col-md-4 col-sm-5 right-panel academic-calender animatedParent">
            <div class="animated bounceInUp slower major-page-right-section">
                <div class="gray-widgets">
                    ...
                    4 years - 8 full semesters
                </div>
                <div class="gray-widgets">
                    <div class="widgets-title">Credit Requirment</div>
                    <table width="100%">
                        <tr>
